...
# `qi-sort` & `qi::apex`
### Ultra-High-Performance Hardware-Aware Sorting Engine for Modern CPUs

<p align="center">
  A <b>zero-dependency, single-header</b> C++17 sorting engine with <b>Go, Python, and Java</b> bindings.<br/>
  Featuring <b><code>qi::apex</code></b> (Strict 20 KB L1-Bound, 8-Way ILP Radix-11, Universal Multi-Type Engine)<br/>
